...
sub main(){
  ...
  my @peerList3   = qw(127.0.0.1:9607 127.0.0.1:9608 127.0.0.1:9609);
  ...
  processOneBlockchain($baseDir, $bcId, $nounce, $zero_count, $ex_zero_count, "127.0.0.1:9607", "7", "07", \@peerList, \@externalChainConsumer, \@externalChainProducer);
  processOneBlockchain($baseDir, $bcId, $nounce, $zero_count, $ex_zero_count, "127.0.0.1:9608", "8", "08", \@peerList, \@externalChainConsumer, \@externalChainProducer);
  processOneBlockchain($baseDir, $bcId, $nounce, $zero_count, $ex_zero_count, "127.0.0.1:9609", "9", "09", \@peerList, \@externalChainConsumer, \@externalChainProducer);
}
