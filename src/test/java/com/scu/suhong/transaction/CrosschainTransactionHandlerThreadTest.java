...
public class CrosschainTransactionHandlerThreadTest {
    @Test
    public void processExternalTransaction() throws BlockException, PoWException {
        CrosschainTransactionHandlerThread crosschainTransactionHandlerThread = CrosschainTransactionHandlerThread.getInstance();
        ...
        assert 0 == crosschainTransactionHandlerThread.testGetExternalTransactionListSize();
        ...
        System.out.println("[Test] ExternalTransactionListSize: " + crosschainTransactionHandlerThread.testGetExternalTransactionListSize());
        assert 2 == crosschainTransactionHandlerThread.testGetExternalTransactionListSize();
...
//        System.out.println(exBlockChain.Dump());
    ...
    public void testInteractionMatch() throws BlockException {
        ...
        CrosschainTransactionHandlerThread crosschainTransactionHandlerThread = new CrosschainTransactionHandlerThread();
        ...
        crosschainTransactionHandlerThread.processExternalTransaction(exTxInBlockchain1);

        System.out.println("\n[Test] begin to process the second transaction");
        tempBlock = packageTransactionToBlock(exTxInBlockchain2, BlockChain.getInstance().getLatestBlock());
        blockChain.getBlockList().add(tempBlock);
        crosschainTransactionHandlerThread.processExternalTransaction(exTxInBlockchain2);

        System.out.println("\n[Test] begin to process the third transaction");
        tempBlock = packageTransactionToBlock(exTxInBlockchain3, BlockChain.getInstance().getLatestBlock());
        blockChain.getBlockList().add(tempBlock);
        crosschainTransactionHandlerThread.processExternalTransaction(exTxInBlockchain3);
