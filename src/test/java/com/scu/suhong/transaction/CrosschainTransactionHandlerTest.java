...
public class CrosschainTransactionHandlerTest {
    @Test
    public void processExternalTransaction() throws BlockException, PoWException {
        CrosschainTransactionHandler crosschainTransactionHandler = CrosschainTransactionHandler.getInstance();

        final String currentChainSenderAddress = "from1";// we only give short name for inner blockchain transaction
        final String currentChainReceiverAddress = "to2";
        final int currentChainSenderInitValue = 20;
        final int currentChainSenderUsedValue = 10;
        int blockchainId = 123;
        int interactionId = 10;
        String from = currentChainSenderAddress;//"0x123_from1";
        ...
        assert 0 == crosschainTransactionHandler.testGetExternalTransactionListSize();
        ...
        System.out.println("[Test] ExternalTransactionListSize: " + crosschainTransactionHandler.testGetExternalTransactionListSize());
        assert 2 == crosschainTransactionHandler.testGetExternalTransactionListSize();
...
//        System.out.println(exBlockChain.dump());
    ...
    public void testInteractionMatch() throws BlockException {
        int blockchainId = 123;
        int interactionId = 10;
        String from = MiningConfiguration.getBlockchainId() + AccountManager.getAddressConnectSymbol() + "from1";
        String to = MiningConfiguration.getBlockchainId() + AccountManager.getAddressConnectSymbol() + "to2";
        String from1 = from;
        String to1 = to;
        int value = 10;
        ...
        blockchainId = 234;
        interactionId = 10;
        from = "222" + AccountManager.getAddressConnectSymbol() + "from1";
        to = "222" + AccountManager.getAddressConnectSymbol() + "to2";
        value = 10;
        CrosschainTransaction exTxInBlockchain2 = createExternalTransaction(blockchainId, interactionId, from, to, value);
        ...
        blockchainId = 345;
        interactionId = 10;
        from = "333" + AccountManager.getAddressConnectSymbol() + "from1";
        to = "333" + AccountManager.getAddressConnectSymbol() + "to2";
        value = 10;
        CrosschainTransaction exTxInBlockchain3 = createExternalTransaction(blockchainId, interactionId, from, to, value);
        ...
        CrosschainTransactionHandler crosschainTransactionHandler = new CrosschainTransactionHandler();
        ...
        crosschainTransactionHandler.processExternalTransaction(exTxInBlockchain1);

        System.out.println("\n[Test] begin to process the second transaction");
        tempBlock = packageTransactionToBlock(exTxInBlockchain2, BlockChain.getInstance().getLatestBlock());
        blockChain.getBlockList().add(tempBlock);
        crosschainTransactionHandler.processExternalTransaction(exTxInBlockchain2);

        System.out.println("\n[Test] begin to process the third transaction");
        tempBlock = packageTransactionToBlock(exTxInBlockchain3, BlockChain.getInstance().getLatestBlock());
        blockChain.getBlockList().add(tempBlock);
        crosschainTransactionHandler.processExternalTransaction(exTxInBlockchain3);
